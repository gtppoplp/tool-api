...
public enum ResultCode implements IErrorCode {
    ...
    MINECRAFT_MOD_LANG_FILE_CONTENT_NONE(2,"lang文件内容读取失败"),
    MINECRAFT_MOD_LANG_FILE_CREATE_ERROR(2,"lang文件内容存储失败"),


    MINECRAFT_MOD_CREATE_CATEGORY_FILE_NONE_LANG(40104, "文件中不存在英文lang文件"),
